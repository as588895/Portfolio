        ...
        <motion.div initial={{opacity:0, x:-20}} animate={{opacity:1, x:0}} transition={{duration:0.6}}>
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4 items-center">
              ...
              <a href="https://drive.google.com/drive/folders/1Di_gj0KIESJ4gRS_mJiIWjB77EO_HvSj" download className="btn-primary">Resume</a>
            </div>
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              ...
              <div className="card-box p-5">
                ...
                <div className="mt-2 font-semibold">Full Stack Developer,REST APIs & Database-Driven Applications</div>
              </div>
              <div className="card-box p-5">
                <div className="text-sm text-muted">Focus</div>
                <div className="mt-2 font-semibold">Data Structures & Algorithms, Frontend & Backend Development</div>
              </div>
            </div>
          </div>
        </motion.div>
        <motion.div initial={{opacity:0, x:20}} animate={{opacity:1, x:0}} transition={{duration:0.6}} className="flex justify-center">
          <div className="w-full max-w-md">
            <div className="rounded-full bg-gradient-to-r from-primary/10 to-accent/10 p-12 flex items-center justify-center">
              <img src="https://img.sanishtech.com/u/ce9f9bbe97e9eebc1d9baa4fe8c6e534.png" alt="Aman Singh profile" className="w-90 h-90 rounded-full object-cover shadow-lg" />
            </div>
          </div>
        </motion.div>
      </div>
